...
public class OrderJFrame extends javax.swing.JFrame {
    ...
    int row = 0;
        ...
        if(txtSoHD.getText().isEmpty()){
            ...
            return false;
        }else if(txtMaOrder.getText().equals("")){
            MgsBox.alert(this, "Vui lòng nhập đầy đủ thông tin!");
            return false;
    ...
    void fillToTableDatMon() {
        ...
        try {
            ...
            for (DatMon datMon : list) {
                Object[] row = {
                    datMon.getMaSoBan(), datMon.getMaOrder(), datMon.getTenMon(), datMon.getDonGia(), datMon.getSoLuong(), datMon.getSoHD()
                };
                model.addRow(row);
    ...
    private DatMon getFormDatMon() {
        ...
        datmon.setTenLoai((String) cboThucDon.getSelectedItem());
        datmon.setTenMon((String) tblThucDon.getValueAt(selectedRow, 0));
        datmon.setDonGia((Double) tblThucDon.getValueAt(selectedRow, 1));
        ...
        datmon.setSoHD(Integer.parseInt(txtSoHD.getText()));
        return datmon;
    }
    ...
    void edit() {
        ...
        if (selectedRow != -1) {
            // Có dòng được chọn
            Object maOrderObject = tblTDDuocChon.getValueAt(selectedRow, 0);
    ...
    private void updateDatMon() {
        ...
        if (selectedRow != -1) {
            ...
            if (maOrderObject != null) {
                ...
                if (model != null) {
                    model.setSoLuong(getSoLuongFromSpinner());
    ...
    private void initComponents() {
        ...
        tblTDDuocChon.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã số bàn", "Mã Order", "Thực đơn", "Đơn giá", "Số lượng"
            }
        ));
