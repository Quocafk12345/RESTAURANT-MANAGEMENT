...
public class NhanVienDAO extends EdusysDAO<NhanVien, String> {
    ...
    final String INSERT_SQL = "INSERT INTO nhanvien(MaNV,TenNV,NgaySinh,SDT,TenDN,CaLam,Email,GioiTinh,MatKhau,VaiTro,MaSoBan) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
    final String UPDATE_SQL = "update nhanvien set TenNV = ?,SDT=?,TenDN=?,NgaySinh = ?,CaLam = ?,Email = ?, GioiTinh = ?,MatKhau = ? ,VaiTro = ?,MaSoBan = ? where MaNV = ?";
    ...
    public void insert(NhanVien entity) {
        JdbcHelper.excuteUpdate(INSERT_SQL, entity.getMaNV(), entity.getTenNV(), entity.getNgaySinh(), entity.getSDT(), entity.getTenDN(), entity.getCaLam(), entity.getEmail(), entity.isGioiTinh(), entity.getMatKhau(), entity.isVaiTro(), entity.getMaSoBan());
    }
    ...
    public void update(NhanVien entity) {
        JdbcHelper.excuteUpdate(UPDATE_SQL, entity.getTenNV(), entity.getSDT(), entity.getTenDN(), entity.getNgaySinh(), entity.getCaLam(), entity.getEmail(), entity.isGioiTinh(), entity.getMatKhau(), entity.isVaiTro(), entity.getMaSoBan(), entity.getMaSoBan(), entity.getMaNV());
    }
