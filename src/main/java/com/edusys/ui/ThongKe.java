...
public class ThongKe extends javax.swing.JFrame {
   ...
   void fillToTableMuaNguyenLieu() {
        ...
        try {
            ...
            for (MuaNguyenLieu muaNguyenLieu : list) {
                Object[] row = {
                    muaNguyenLieu.getMaMuaNL(),muaNguyenLieu.getThoiGianLap(), muaNguyenLieu.getTenMon(),muaNguyenLieu.getSoLuong(),muaNguyenLieu.getDaDung(),muaNguyenLieu.getDaHuy(),muaNguyenLieu.getConLai()
                };
                model.addRow(row);
   ...
   void fillToTableThucDon() {
        ...
        try {
            ...
            int columnWidth = 100;
            for (Mon td : list) {
                Object[] rows = {td.getMaMon(),  td.getNgayADGia(),td.getTenMon(), td.getTenLoai(),td.getSoLuongDaBan()};
                model.addRow(rows);
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void initComponents() {
        ...
        tblNguyenLieu.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã nguyên liệu", "Thời gian", "Tên nguyên liệu", "Số lượng", "Đã sử dụng", "Đã hủy", "Còn lại"
            }
        ));
        ...
        tblThucDon.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã thực đơn", "Thời gian", "Tên thực đơn", "Loại thực đơn", "Số lượng đã bán"
            }
        ));
    ...
    private void btnXuatFileExcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXuatFileExcelActionPerformed
        // TODO add your handling code here:
          excelExporter.exportToExcel(tblDoanhThu, "C:\\Users\\MS QUOC\\Documents\\NetBeansProjects\\mavenproject\\src\\main\\java\\com\\edusys\\excel\\ThongKe.xlsx");
