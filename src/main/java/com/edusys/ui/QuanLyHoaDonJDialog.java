...
public class QuanLyHoaDonJDialog extends javax.swing.JDialog {
    ...
    public QuanLyHoaDonJDialog(java.awt.Frame parent, boolean modal) {
        ...
        dateTu.addPropertyChangeListener(new PropertyChangeListener() {
            @Override
            public void propertyChange(PropertyChangeEvent evt) {
                if ("date".equals(evt.getPropertyName())) {
                    Date startDate = dateTu.getDate();
                    Date endDate = dateDen.getDate();
                    hoaDonDAO.searchInvoicesByDateRange(startDate, endDate);
                }
            }
        });
        dateDen.addPropertyChangeListener(new PropertyChangeListener() {
            @Override
            public void propertyChange(PropertyChangeEvent evt) {
                if ("date".equals(evt.getPropertyName())) {
                    Date startDate = dateTu.getDate();
        ...
        dateThang.addPropertyChangeListener(new PropertyChangeListener() {
            @Override
            public void propertyChange(PropertyChangeEvent evt) {
                if ("Month".equals(evt.getPropertyName())) {
                    int Month = dateThang.getMonth();
                    hoaDonDAO.searchInvoicesByMonthRange(Month);
                }
            }
        });
    }
...
//        Month selectedThang = dateThang.getMonth();
//
...
//
//    }
    void ShowRecordsHoaDonByDateRange() {
        Date selectedTu = dateTu.getDate();
        Date selectedDen = dateDen.getDate();

        try {
            List<HoaDon> records = hoaDonDAO.searchInvoicesByDateRange(selectedTu, selectedDen);
            HienThiBanGhiHoaDonTuNgayDenNgay(records);
        } catch (Exception e) {
            e.printStackTrace();
            MgsBox.alert(this, "Error displaying invoices by date range.");
        }
    }

    void HienThiBanGhiHoaDonTuNgayDenNgay(List<HoaDon> records) {
        DefaultTableModel model = (DefaultTableModel) tblHoaDon.getModel();
        model.setRowCount(0);
    ...
    void ShowRecordsHoaDonByMonthRange() {
        int selectedThang = dateThang.getMonth();

        try {
            List<HoaDon> records = hoaDonDAO.searchInvoicesByMonthRange(selectedThang);
            HienThiBanGhiHoaDonTuNgayDenNgay(records);
        } catch (Exception e) {
            e.printStackTrace();
            MgsBox.alert(this, "Error displaying invoices by date range.");
    ...
    void ShowRecordsHoaDonByYearRange() {
        int selectedNam = dateYear.getYear();

        try {
            List<HoaDon> records = hoaDonDAO.searchInvoicesByYearRange(selectedNam);
            HienThiBanGhiHoaDonTheoNam(records);
        } catch (Exception e) {
            e.printStackTrace();
            MgsBox.alert(this, "Error displaying invoices by date range.");
        }
    ...
    void HienThiBanGhiHoaDonTheoNam(List<HoaDon> records) {
        DefaultTableModel model = (DefaultTableModel) tblHoaDon.getModel();
        model.setRowCount(0);
    ...
    private void initComponents() {
        ...
        dateThang = new com.toedter.calendar.JMonthChooser();
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(16, 16, 16)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(dateThang, javax.swing.GroupLayout.PREFERRED_SIZE, 175, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(dateThang, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnTuNgayDenNgayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTuNgayDenNgayActionPerformed
        ...
        if (startDate != null && endDate != null) {
            try {
                ...
                List<HoaDon> invoices = hoaDonDAO.searchInvoicesByDateRange(startDate, endDate);

                // Display the search results in the table
                HienThiBanGhiHoaDonTuNgayDenNgay(invoices);
            } catch (Exception e) {
                e.printStackTrace();
                MgsBox.alert(this, "Error searching for invoices.");
            }
        } else {
            MgsBox.alert(this, "Please select both start and end dates.");
        }
...
//                ShowRecordsHoaDonByMonth();
        int selectedThang = dateThang.getMonth() + 1; // Bổ sung 1 để chuyển đổi tháng từ 0-11 thành 1-12

        try {
            List<HoaDon> invoices = hoaDonDAO.searchInvoicesByMonthRange(selectedThang);
            HienThiBanGhiHoaDonTheoThang(invoices);
        } catch (Exception e) {
            e.printStackTrace();
            MgsBox.alert(this, "Lỗi khi tìm hóa đơn theo tháng.");
        }
    ...
    private void btnNamActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNamActionPerformed
        // TODO add your handling code here:
        int selectedYear = dateYear.getYear();

        try {
            List<HoaDon> invoices = hoaDonDAO.searchInvoicesByYearRange(selectedYear);
            HienThiBanGhiHoaDonTheoNam(invoices);
        } catch (Exception e) {
            e.printStackTrace();
            MgsBox.alert(this, "Lỗi khi tìm hóa đơn theo tháng.");
        }
    ...
    private com.toedter.calendar.JMonthChooser dateThang;
