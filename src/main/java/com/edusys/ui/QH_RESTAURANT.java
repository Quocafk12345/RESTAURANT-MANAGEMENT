...
public class QH_RESTAURANT extends javax.swing.JFrame {
    ...
    btnHoaDon = new JButton("Lập Hóa Đơn");
    btnBep = new JButton("Bếp");
    btnDX = new JButton("Đăng Xuất");
    btnQLNV = new JButton("Quản Lý Nhân Viên");
    btnThongKe = new JButton("Thống Kê");
    btnTaiKhoan = new JButton("Tài Khoản");
    btnBep1 = new JButton("Bếp 1");
    btnOrder = new JButton("Order");
    btnThanhToan = new JButton("Thanh Toán");
    btnBanAn = new JButton("Bàn Ăn");
    btnQuanLyHoaDon = new JButton("Quản Lý Hóa Đơn");

    // Thêm hiệu ứng chuột cho từng nút
    addMouseEffect(btnMenu);
    addMouseEffect(btnHoaDon);
    addMouseEffect(btnBep);
    addMouseEffect(btnDX);
    addMouseEffect(btnQLNV);
    addMouseEffect(btnThongKe);
    addMouseEffect(btnTaiKhoan);
    addMouseEffect(btnBep1);
    addMouseEffect(btnOrder);
    addMouseEffect(btnThanhToan);
    addMouseEffect(btnBanAn);
    addMouseEffect(btnQuanLyHoaDon);

    // Các cài đặt khác của giao diện
}
    ...
    button.addMouseListener(new MouseAdapter() {
        ...
        public void mouseExited(MouseEvent e) {
            ...
            button.setBackground(UIManager.getColor("Button.background")); // Màu mặc định của nút
        }
    });
}
...
// Cập nhật nội dung của JLabel với ngày hiện tại
    ...
    void openBanAn() {
        frmChonBan banAn = new frmChonBan();
...
//    }
    ...
    private void initComponents() {
        ...
        btnOrder.setBackground(new java.awt.Color(0, 102, 102));
        ...
        btnBanAn.setBackground(new java.awt.Color(0, 102, 102));
        btnBanAn.setFont(new java.awt.Font("Segoe UI Black", 1, 36)); // NOI18N
        btnBanAn.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/edusys/icon/images/logoMini.png"))); // NOI18N
        ...
        btnQLNV.setBackground(new java.awt.Color(0, 102, 102));
        ...
        btnQuanLyHoaDon.setBackground(new java.awt.Color(0, 102, 102));
        ...
        btnBep.setBackground(new java.awt.Color(0, 102, 102));
        btnBep.setFont(new java.awt.Font("Segoe UI Black", 1, 12)); // NOI18N
        btnBep.setForeground(new java.awt.Color(255, 255, 255));
        btnBep.setText("BẾP");
        ...
        lblHinhAnh.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/edusys/icon/images/NhanVien.png"))); // NOI18N
        ...
        btnBep1.setBackground(new java.awt.Color(0, 102, 102));
        btnBep1.setFont(new java.awt.Font("Segoe UI Black", 1, 12)); // NOI18N
        btnBep1.setForeground(new java.awt.Color(255, 255, 255));
