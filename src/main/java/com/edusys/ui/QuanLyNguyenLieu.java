...
public class QuanLyNguyenLieu extends javax.swing.JDialog {
    ...
    int row = 0;
     ...
     boolean validateForm(){
        if(txtMaNguyenLieu.getText().isEmpty()){
            ...
            return false;
        }else if(txtTenNguyenLieu.getText().equals("")){
            MgsBox.alert(this, "Vui lòng nhập đầy đủ thông tin!");
            return false;
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Danh Sách Nguyên Liệu");
        ...
        jLabel17.setText("Tra cứu nguyên liệu");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(cc, javax.swing.GroupLayout.PREFERRED_SIZE, 789, javax.swing.GroupLayout.PREFERRED_SIZE)
