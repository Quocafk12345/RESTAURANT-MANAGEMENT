...
public class QuanLyThucDonJDialog extends javax.swing.JDialog {
    ...
    boolean validateForm() {
        if (txtID.getText().isEmpty()) {
            ...
            MgsBox.alert(this, "Vui lòng nhập đầy đủ thông tin!");
            return false;
        } else if (txtTraCuuTen.getText().equals("")) {
            MgsBox.alert(this, "Vui lòng nhập đầy đủ thông tin!");
            return false;
        } else if (txtTraCuuTen.getText().equals("")) {
            MgsBox.alert(this, "Vui lòng nhập từ khóa cần tra cứu!");
            return false;
        } else if (txtDonViTinh.getText().equals("")) {
            MgsBox.alert(this, "Vui lòng nhập đầy đủ thông tin!");
            return false;
        }
        return true;
    ...
    void setForm(Mon td) {
        txtID.setText(Integer.valueOf(td.getMaMon()).toString());
    ...
    private Mon getForm() {
        Mon td = new Mon();
        td.setMaMon(Integer.parseInt(txtID.getText()));
    ...
    private void initComponents() {
        ...
        cc.add(txtID, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 170, 200, 30));
