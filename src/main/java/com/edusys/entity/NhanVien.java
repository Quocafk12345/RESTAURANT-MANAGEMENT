...
public class NhanVien {
    ...
    public NhanVien(String maNV, String TenNV, Date NgaySinh, String SDT, String TenDN, String CaLam, String Email, String matKhau, boolean VaiTro,String MaSoBan,String HinhAnh) {
        this.MaNV = MaNV;
        this.TenNV = TenNV;
