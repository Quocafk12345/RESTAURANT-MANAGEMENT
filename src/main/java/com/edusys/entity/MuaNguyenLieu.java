...
public class MuaNguyenLieu{
    ...
    public MuaNguyenLieu(int MaMuaNL, String TenLoai, String TenMon, double DonGia, int SoLuong, Date ThoiGianLap, int SoHD, String HinhAnh, int MaNguyenLieu, int MaLoai, String DonViTinh, int DaDung, int DaHuy, int ConLai) {
